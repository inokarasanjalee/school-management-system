<?php
// [Vuln 6 Fix] Secure session cookie (HttpOnly + SameSite)
require_once 'session_config.php';
// [Vuln 2 Fix] CSP + Clickjacking + X-Content-Type-Options headers
...
// [Vuln 1 Fix] Generate CSRF token for all forms on this page
...
<head>
    ...
    <!-- [Vuln 4 Fix] SRI integrity hashes on all CDN resources -->
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css"
          ...
          crossorigin="anonymous">
    <!-- CSP FIX: Moved inline styles to external file — removes 'unsafe-inline' from style-src -->
    ...
    <div class="tab-pane fade show active" id="login" role="tabpanel">
        <form action="login/login.php" method="POST">
            ...
            <div class="mb-3 password-toggle">
                ...
                <!-- CSP FIX: onclick moved to external JS (auth.js) via event listener -->
                <span class="toggle-icon" data-target="loginPassword">👁️</span>
            </div>
    ...
    <div class="tab-pane fade" id="register" role="tabpanel">
        <form action="login/register.php" method="POST" id="registerForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="census" id="census" class="form-control"
                       placeholder="Enter your school census number" required>
                <div id="schoolPreview" class="form-text text-muted mt-1"></div>
            </div>
            <div class="mb-3">
                <label class="form-label">School Name</label>
                <input type="text" name="school" id="school" class="form-control"
                       placeholder="School name will auto-fill" readonly>
            </div>
            <div class="mb-3">
                <label class="form-label">Email Address</label>
                <input type="email" name="email" class="form-control" placeholder="Enter your email" required>
            ...
            <div class="mb-3 password-toggle">
                ...
                <span class="toggle-icon" data-target="regPassword">👁️</span>
            </div>
            <div class="mb-3 password-toggle">
                <label class="form-label">Confirm Password</label>
                <input type="password" name="confirm" id="confirmPassword" class="form-control"
                       placeholder="Confirm your password" required>
                <span class="toggle-icon" data-target="confirmPassword">👁️</span>
            </div>
        ...
        <div class="g_id_signin" data-type="standard" data-size="large" data-theme="outline"
             data-text="signup_with" data-shape="rectangular" data-logo_alignment="left" data-width="300">
        </div>
